...
public class PolicyApplication
{
    ...
    public string UserId { get; set; } = string.Empty; // the buyer
    ...
    public decimal CalculatedPremium { get; set; } // final cost
    ...
    public DateTime? ApprovedAt { get; set; } // approval time

    // total money covered by this policy
    public decimal TotalCoverageAmount { get; set; }
    // how much coverage is left
    public decimal RemainingCoverageAmount { get; set; } // money left
    ...
    // when policy ends
    public DateTime? ExpiryDate { get; set; } // end date
    ...
    public ApplicationUser? AssignedAgent { get; set; } // agent object
}
// policy application details end
