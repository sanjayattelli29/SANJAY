...
namespace Infrastructure.Services
{
    ...
    public class ClaimService : IClaimService
    {
        ...
        // code for customer to tell about a problem to raise the claim process
        public async Task<AuthResponseDto> RaiseClaimAsync(string userId, RaiseClaimRequest request)
        {
            ...
            //This line tells EF to add the new claim object into the InsuranceClaims table.
        ...
        public async Task<IEnumerable<InsuranceClaim>> GetPendingClaimsAsync()
        {
            return await _context.InsuranceClaims
                ...
                .Include(c => c.Documents) // missing include added here to show digital evidence
